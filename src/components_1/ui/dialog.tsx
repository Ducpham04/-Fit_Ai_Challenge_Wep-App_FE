...
function Dialog({
  ...
  // prevent overlay/content from mounting when dialog is closed to avoid
  // an invisible overlay capturing pointer events and blocking page clicks
  const { children, ...rest } = props as any;
  console.log("[Dialog] open:", open, "onOpenChange:", typeof onOpenChange);
  return (
    <DialogPrimitive.Root data-slot="dialog" open={open} onOpenChange={onOpenChange} {...rest}>
      {open ? children : null}
...
const DialogHeader = React.forwardRef<any, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
...
const DialogFooter = React.forwardRef<any, React.ComponentProps<"div">>(
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
